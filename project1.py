...
class CakeWin(QtWidgets.QDialog):
    ...
    def _define_widgets(self):
        ...
        self.level_spnbx.setMinimum(1)
        self.level_spnbx.setMaximum(99)
        self.level_spnbx.setValue(5)
        self.level_slider = QtWidgets.QSlider()
        self.level_slider.setMinimum(1)
        self.level_slider.setMaximum(99)
        self.level_slider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.cake_height_dsb.setValue(3.0)
        ...
        self.cake_width_dsb.setValue(1.0)
        self.cake_width_layout.addWidget(self.cake_width_lbl)
        self.cake_width_layout.addWidget(self.cake_width_dsb)
        ...
        self.cake_proportion_dsb.setMinimum(0.25)
        self.cake_proportion_dsb.setMaximum(1.0)
        self.cake_proportion_dsb.setSingleStep(0.05)
        self.cake_proportion_dsb.setValue(0.75)
    ...
    def _define_color_widgets(self):
        ...
        self.red_spnbx = QtWidgets.QSpinBox()
        self.red_spnbx.setMinimum(1)
        self.red_spnbx.setMaximum(100)
        self.red_spnbx.setSingleStep(5)
        self.red_spnbx.setValue(100)
        ...
        self.red_layout.addWidget(self.red_spnbx)
        self.red_layout.addWidget(self.red_slider)

        self.green_layout = QtWidgets.QHBoxLayout()
        self.green_lbl = QtWidgets.QLabel("G(%)")
        self.green_spnbx = QtWidgets.QSpinBox()
        self.green_spnbx.setMinimum(1)
        self.green_spnbx.setMaximum(100)
        self.green_spnbx.setSingleStep(5)
        self.green_spnbx.setValue(100)
        self.green_slider = QtWidgets.QSlider()
        self.green_slider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.green_slider.setMinimum(1)
        ...
        self.green_layout.addWidget(self.green_spnbx)
        self.green_layout.addWidget(self.green_slider)

        self.blue_layout = QtWidgets.QHBoxLayout()
        self.blue_lbl = QtWidgets.QLabel("B(%)")
        self.blue_spnbx = QtWidgets.QSpinBox()
        self.blue_spnbx.setMinimum(1)
        self.blue_spnbx.setMaximum(100)
        self.blue_spnbx.setSingleStep(5)
        self.blue_spnbx.setValue(100)
        self.blue_slider = QtWidgets.QSlider()
        self.blue_slider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.blue_slider.setMinimum(1)
        ...
        self.blue_layout.addWidget(self.blue_spnbx)
        self.blue_layout.addWidget(self.blue_slider)

    def _layout_ui(self):
        self.main_layout = QtWidgets.QVBoxLayout()
        self.main_layout.addLayout(self.icing_layout)
        self.main_layout.addLayout(self.level_layout)
        self.main_layout.addLayout(self.cake_height_layout)
        self.main_layout.addLayout(self.cake_width_layout)
        self.main_layout.addLayout(self.cake_proportion_layout)
        self.main_layout.addLayout(self.red_layout)
        self.main_layout.addLayout(self.green_layout)
        self.main_layout.addLayout(self.blue_layout)
    ...
    def _connect_signals(self):
        ...
        self.red_spnbx.valueChanged.connect(self.red_slider.setValue)
        self.red_slider.valueChanged.connect(self.red_spnbx.setValue)
        self.green_spnbx.valueChanged.connect(self.green_slider.setValue)
        self.green_slider.valueChanged.connect(self.green_spnbx.setValue)
        self.blue_spnbx.valueChanged.connect(self.blue_slider.setValue)
        self.blue_slider.valueChanged.connect(self.blue_spnbx.setValue)
    ...
    def generate_cake(self):
        ...
        self.cake.cake_red = (self.red_spnbx.value()/100.0)
        self.cake.cake_green = (self.green_spnbx.value()/100.0)
        self.cake.cake_blue = (self.blue_spnbx.value()/100.0)
        self.cake.icing = self.icing_checkbox.isChecked()
        self.cake.generate_cake()
